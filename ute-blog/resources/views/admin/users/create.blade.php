...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Thêm người dùng mới</h2>
                <p class="text-gray-500 mt-1">Tạo tài khoản cho thành viên mới trong hệ thống</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1.5 text-xs text-gray-500">Mật khẩu nên chứa chữ hoa, chữ thường và số</p>
                    @error('password')
                        <p class="mt-2 text-sm text-red-600 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select id="role" name="role" required
                        ...
                        <option value="content_manager" {{ old('role') == 'content_manager' ? 'selected' : '' }}>✍️ Content Manager</option>

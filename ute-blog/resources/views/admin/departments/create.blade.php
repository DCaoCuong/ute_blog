    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Thêm đơn vị mới</h2>
                    <p class="text-gray-500 mt-1">Tạo Khoa, Phòng Ban hoặc Trung tâm mới</p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.departments.store') }}">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="type" name="type" required
                            ...
                            <option value="faculty" {{ old('type') == 'faculty' ? 'selected' : '' }}>🎓 Khoa</option>
                            <option value="office" {{ old('type') == 'office' ? 'selected' : '' }}>🏢 Phòng Ban</option>
                            <option value="center" {{ old('type') == 'center' ? 'selected' : '' }}>🏛️ Trung tâm</option>
                        </select>
                        @error('type')
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-xs text-gray-500">💡 Dùng để tạo cấu trúc phân cấp</p>
                        @error('parent_id')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="description" name="description" rows="2"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                        placeholder="Mô tả ngắn gọn về đơn vị...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="content" name="content" rows="6"
                        ...
                        placeholder="Nội dung chi tiết về đơn vị (có thể dùng HTML)...">{{ old('content') }}</textarea>
                    @error('content')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-between bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <button type="submit"
                    class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-lg hover:from-indigo-700 hover:to-indigo-800 transition shadow-lg hover:shadow-xl">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
